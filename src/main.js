...
function changeBackgroundColorHandler(e) {
...
links.addEventListener('click', toggleLinksHandler)

const btnClickMe = document.querySelector('#click-me')
btnClickMe.addEventListener('click', changeBackgroundColorHandler)
